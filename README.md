...
| 4.   | [Анализ данных](https://github.com/KseniaKar/Portfolio/tree/main/games) | Исследование закономерностей, определяющих популярность компьютерных игр           | python, pandas, numpy, scipy, matplotlib, seaborn |
